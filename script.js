...
class SocialProofNotifications {
    constructor() {
        ...
        this.notificationTemplates = [
            ...
            'اشترى للتو كشاف ليزر Police 288',
            'طلب قطعتين من كشاف Police 288',
            'أضاف كشاف Police 288 إلى السلة',
            'أكمل طلب شراء كشاف Police 288',
            'اختار العرض الخاص لكشاف Police 288',
            'أكد طلبه من كشاف Police 288 🔥',
            'استفاد من العرض المحدود!',
            'طلب توصيل سريع لكشاف Police 288',
    ...
    switch(field.id) {
        ...
        case 'phone':
            if (!value) {
                ...
                errorMessage = 'رقم هاتف غير صحيح (يجب أن يبدأ بـ 01 ويحتوي 11 رقم)';
                isValid = false;
            }
            break;
            
        case 'whatsapp':
            // حقل الواتساب اختياري، لكن إذا تم إدخاله يجب أن يكون صحيحاً
            if (value && !/^01[0-9]{9}$/.test(value)) {
                errorMessage = 'رقم واتساب غير صحيح (يجب أن يبدأ بـ 01 ويحتوي 11 رقم)';
                isValid = false;
            }
            break;
